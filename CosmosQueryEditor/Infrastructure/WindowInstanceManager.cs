...
namespace CosmosQueryEditor.Infrastructure
{
    public class WindowInstanceManager : IWindowInstanceManager
    {
        ...
        {
            if (mainWindowViewModelFactory == null)
                throw new ArgumentNullException(nameof(mainWindowViewModelFactory));
                                              ...
                                              .SelectMany(
                                                          tabControl =>
                                                                  tabControl.Items.OfType<TabItemContainer>()
                                                                            .Select(tabItemContainer => new
                                                                                                        {
                                                                                                                tabControl,
                                                                                                                tabViewModel = tabItemContainer
                                                                                                        }))
