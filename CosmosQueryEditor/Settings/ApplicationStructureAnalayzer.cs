...
namespace CosmosQueryEditor.Settings
{
    public static class LayoutAnalayzer
    {
        ...
        {
            foreach (var layoutItem in Layout.GetLoadedInstances().Select(layout => new
                                                                                    {
                                                                                            layout,
                                                                                            window = Window.GetWindow(layout)
                                                                                    }))
            {
                ...
                layoutAccessor.Visit(branchAccessor => { VisitAndDocumentChildren(branchAccessor, null, layoutStructureBranches, layoutStructureTabSets); },
